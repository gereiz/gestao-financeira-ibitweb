                    ...
                    {!hasAccess ? (
                        <div className="bg-white dark:bg-dark-card overflow-hidden shadow-sm sm:rounded-lg p-12 text-center">
                            ...
                            <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-md mx-auto">
                                O gerenciamento de categorias está disponível apenas para usuários do plano Premium.
                                Faça um upgrade para personalizar suas categorias e organizar melhor suas finanças.
                            </p>
                            <Link
